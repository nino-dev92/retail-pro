...
export default function Header() {
  return (
    <nav className="sticky top-0 z-50 w-full border-b bg-surface">
      <div className="mx-auto flex max-w-container-max w-full items-center justify-between px-margin-desktop py-4">
        ...
        <div className="flex items-center gap-4">
          <NavLink
            to="/login"
            className="rounded border border-outline-variant px-4 py-2 text-primary transition-all duration-200 hover:bg-primary hover:text-on-primary active:scale-95"
          >
            Login
          </NavLink>
